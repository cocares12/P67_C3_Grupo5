"""
Django settings for projectHeladeria project.
...
SECRET_KEY = 'django-insecure-tq#v^jc%+3q71jks!*%w)zg4@73b6@(qvylrq&02*v07!l@+0z'
...
WSGI_APPLICATION = 'projectHeladeria.wsgi.application'
